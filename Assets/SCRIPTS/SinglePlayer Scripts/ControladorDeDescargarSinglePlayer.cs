...
public class ControladorDeDescargarSinglePlayer : MonoBehaviour
{
	...
	public AnimacionDepositoSingleplayer ObjAnimado;
	...
	public void Activar(DepositoSinglePlayer d)
	{
