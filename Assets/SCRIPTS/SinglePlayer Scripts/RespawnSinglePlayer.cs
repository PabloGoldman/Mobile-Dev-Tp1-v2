...
public class RespawnSinglePlayer : MonoBehaviour
{
	CheakPointSinglePlayer CPAct;
	CheakPointSinglePlayer CPAnt;
	...
	public void Respawnear()
	{
		...
		if (CPAct.Habilitado())
		{
			if (GetComponent<VisualizacionSinglePlayer>().LadoAct == VisualizacionSinglePlayer.Lado.Der)
	...
	public void AgregarCP(CheakPointSinglePlayer cp)
	{
		if (cp != CPAct)
		{
			CPAnt = CPAct;
